...
```javascript
import Vue from 'vue';
import ElementUI from 'km-element-ui';
import 'km-element-ui/lib/theme-chalk/index.css';
...
```javascript
import Vue from 'vue';
import { Button, Select } from 'km-element-ui';
import App from './App.vue';
...
```js
import Vue from 'vue';
import { Button } from 'km-element-ui';
