<template>
  <div>
    ...
    <el-virtual-table
      ...
      border
    >
      <el-virtual-table-column type="index" width="100" fixed />
      <el-virtual-table-column
        ...
        :width="item.width"
      />
      <el-virtual-table-column fixed="right" label="操作" width="150">
