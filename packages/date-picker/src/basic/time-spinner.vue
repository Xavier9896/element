...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'km-element-ui/src/utils/date-util';
  import ElScrollbar from 'km-element-ui/packages/scrollbar';
  import RepeatClick from 'km-element-ui/src/directives/repeat-click';
